...
class VRayOperatorBase(bpy.types.Operator):
    """ Base class for V-Ray operators in Blender.

        This class provides a common poll method to ensure that the operator is only available
        when the V-Ray engine is active in the current context.
    """
    @classmethod
